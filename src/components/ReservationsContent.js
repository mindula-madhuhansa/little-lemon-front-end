...
export const ReservationsContent = () => {
  ...
  const validateForm = () => {
    ...
    if (formData.telephone === "") {
      err.telephone = "* Telephone number required";
    } else {
      let phoneRegex =
    ...
    <div className="res-content-wrapper">
      <div className="res-content-container">
        <div className="text">
          ...
          <p>Book a table in our restaurant and feel this experience.</p>
        </div>
        <div className="form">
          <h1>Reserve a Table</h1>
          <p>
            Please fill this form and submit to book your reservation at Little
            Lemon Restaurant.
          </p>
